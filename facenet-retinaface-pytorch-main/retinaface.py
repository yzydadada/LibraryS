...
class Retinaface(object):
    _defaults = {
        "retinaface_model_path" : 'C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/Retinaface_mobilenet0.25.pth',
        #-----------------------------------#
        ...
        "facenet_model_path"    : 'C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/facenet_inception_resnetv1.pth',
        #-----------------------------------#
        #   可选facenet_backbone有
    ...
    def __init__(self, encoding=0, **kwargs):
        ...
        try:
            self.known_face_encodings = np.load("C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/{backbone}_face_encoding.npy".format(backbone=self.facenet_backbone))
            self.known_face_names     = np.load("C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/{backbone}_names.npy".format(backbone=self.facenet_backbone))
        except:
            if not encoding:
    ...
    def encode_face_dataset(self, image_paths, names):
        ...
        np.save("C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/{backbone}_face_encoding.npy".format(backbone=self.facenet_backbone),face_encodings)
        np.save("C:/Users/YZY/PycharmProjects/LibraryS/facenet-retinaface-pytorch-main/model_data/{backbone}_names.npy".format(backbone=self.facenet_backbone),names)
